...
router.post('/', authenticate, uploadLimiter, upload.array('files', 5), NoticeController.createNotice);

router.put('/:noticeId', authenticate, uploadLimiter, upload.array('files', 5), NoticeController.editNotice);
